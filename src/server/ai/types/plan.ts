...
export const IngredientPoolSchema = z.object({
  period: z
    .string()
    .describe("対象となる日付の範囲 (例: 2026-02-07 to 2026-02-09)"),
  ingredients: z
    .array(z.string())
    .describe("この期間内で使い回す主要な食材のリスト"),
...
export const WeeklySkeletonSchema = z.object({
  ...
  ingredientPools: z
    .array(IngredientPoolSchema)
    .describe("数日単位のブロックごとの食材計画"),
});
