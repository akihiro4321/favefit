        ...
        <CardContent className="p-6 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <h3 className="font-bold text-lg border-l-4 border-primary pl-2">材料</h3>
            ...
            {/* 調理手順 */}
            <div className="space-y-4">
              <h3 className="font-bold text-lg border-l-4 border-primary pl-2">作り方</h3>
              <div className="space-y-4">
...
function NutritionItem({ icon, label, value }: { icon: React.ReactNode, label: string, value: string }) {
  return (
